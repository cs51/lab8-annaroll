...
......................................................................*)
  ...
  let remove_listener (evt : 'a event) (i : id) : unit =
    let rec helper (evt : 'a waiter list) : 'a waiter list =
      match evt with
      | [] -> []
      | h :: t -> if h.id = i then helper t else h :: helper t
    in
    evt := helper !evt
...
let l1 = WEvent.add_listener newswire fakeNewsNetwork ;;
let l2 = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire l1 ;;
WEvent.remove_listener newswire l2 ;;
...
let receive_report (s : string) : unit =
  let l () = fakeNewsNetwork s; buzzFake s in
  let _ = WEvent.add_listener publish l in () ;;
...
let l3 = WEvent.add_listener newswire receive_report ;;
